...
function ContactForm() {
  ...
  return (
    <section className="relative  2xl:pt-10 bg-gray-800">
          ...
          <div className="flex flex-wrap -mx-4">
            ...
            >
              <div className="max-w-md lg:ml-20">
                <form onSubmit={sendEmail} ref={formRef} id="message-form">
                  ...
                  <button
                    className="py-4 px-12 text-white font-bold bg-blue-500 hover:bg-blue-600 transition duration-200 rounded-xl"
                    type="submit"
                  >
                    Send message
                  </button>
