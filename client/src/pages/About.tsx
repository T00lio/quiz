          ...
          <div className="flex flex-wrap mb-16 lg:mb-28">
            <div className="w-full lg:w-1/2 mb-16 lg:mb-0">
              <div className="max-w-md">
                ...
                <p className="mb-16 text-xl text-white">
                  As I saw this topic appear on my Linked In feed over and over,
                  I wanted to include this into my topics into my study routine
                  but I could not find a place where all of these questions
                  where together, so I decided to go ahead and create it.
                  Initially I only considered to do a simple React quiz, but
                  then I challenged myself and decided to add more topics and it
                  turned out to be simple that I originally thought
                </p>
                <a
            ...
            <div className="w-full lg:w-1/3 p-4">
              <div className="flex pt-8 flex-col items bg-gray-500 p-6 rounded-lg shadow-md opacity-5">
                ...
                <div className="max-w-xs">
                  ...
                  <p className="text-lg text-white">
                    The exposure to this content will make a master in no time,
                    plus you will be able to show off to your friends
                  </p>
                </div>
              </div>
            </div>
