module.exports = {
  ...
  theme: {
    ...
    backgroundColor: (theme) => ({
      ...theme("colors"),
      body: "background: rgb(191,191,191); background: linear-gradient(0deg, rgba(191,191,191,1) 0%, rgba(31,31,31,1) 100%);",
    }),
    backgroundImage: {
      none: "none",
    ...
    fontFamily: {
      ...
      sans: '"Roboto Flex", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"',
