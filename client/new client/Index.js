      ...
      <>
        ...
        <section className='py-20 bg-gray-400'>
          <div className='container px-4 mx-auto'>
            <h2 className='mb-12 text-center text-xl font-bold font-heading'>
              Test your knowledge with our quiz
            </h2>
            <div className='flex flex-wrap -m-4'>
              <div className='w-full md:w-1/2 lg:w-1/4 p-4'>
                <div className='flex w-full h-32 items-center justify-center border-2 border-gray-600 rounded-lg bg-gray-100'>
                  <img
                    className='h-16'
                    src='images/React-Logo-SVG-svg.png'
                    alt=''
                  />
                </div>
              </div>
              <div className='w-full md:w-1/2 lg:w-1/4 p-4'>
                <div className='flex w-full h-32 items-center justify-center border-2 border-gray-600 rounded-lg bg-gray-100'>
                  <img
                    className='h-16'
                    src='images/HTML5-logo-and-wordmark-svg.png'
                    alt=''
                  />
                </div>
              </div>
              <div className='w-full md:w-1/2 lg:w-1/4 p-4'>
                <div className='flex w-full h-32 items-center justify-center border-2 border-gray-600 rounded-lg bg-gray-100'>
                  <img
                    className='h-16'
                    src='images/CSS3-logo-and-wordmark-svg.png'
                    alt=''
                  />
                </div>
              </div>
