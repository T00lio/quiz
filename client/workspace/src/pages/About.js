        ...
        <section className='relative pt-20 pb-20 2xl:pb-40 overflow-hidden bg-black'>
          <div className='container px-4 mx-auto'>
            <div className='flex flex-wrap mb-16 lg:mb-28'>
              <div className='w-full lg:w-1/2 mb-16 lg:mb-0'>
                <div className='max-w-md'>
                  ...
                  <p className='mb-16 text-xl text-gray-300'>
                    As I saw this topic appear over and over on my linked in
                    feed, I wanted to include this into my topics into my study
              ...
              <img
                className='lg:absolute lg:h-144 mr-auto h-128 top-0 right-20'
                ...
                <div className='flex pt-8 lg:pt-20 border-t border-gray-50'>
                  ...
                  <div className='max-w-xs'>
                    ...
                    <p className='text-lg text-white'>
                      ...
                      and out, think of it like a workout. More res, more gains{' '}
                    </p>
                  </div>
                </div>
              </div>
